...
import com.onlinelibrary.beans.BookBean;
import com.onlinelibrary.beans.IssueBookBean;
import com.onlinelibrary.db.BookDao;
...
public class IssueBook extends HttpServlet {
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		IssueBook1 bean=new IssueBook1(callno,studentid,studentname,studentmobile);
